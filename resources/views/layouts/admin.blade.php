    ...
    <header class="bg-[#D9D9D9] text-black border-b border-zinc-300 sticky top-0 z-50">
        <div class="max-w-7xl mx-auto px-8 py-5 flex items-center justify-between">
            ...
            <nav class="hidden md:flex items-center gap-x-10 text-sm font-medium">
                <a href="{{ route('admin.dashboard') }}" class="hover:text-amber-700 transition-colors">Home</a>
                <a href="{{ route('admin.reports.sales') }}" class="hover:text-amber-700 transition-colors">Report</a>
                <a href="{{ route('admin.staff.index') }}" class="hover:text-amber-700 transition-colors">Staff list</a>
                <a href="{{ route('admin.users.index') }}" class="hover:text-amber-700 transition-colors">User list</a>
                <a href="{{ route('admin.backups.index') }}" class="hover:text-amber-700 transition-colors">Backup</a>
            </nav>
