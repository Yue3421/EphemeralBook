...
@section('content')
    <div class="max-w-7xl mx-auto px-8 py-12">
        <section class="text-center mb-10">
            ...
            <div class="mt-4">
                <a href="{{ route('admin.reports.exportPdf', ['type' => 'sales']) }}"
                   class="inline-flex bg-[#8B7B7B] hover:bg-[#7A6A6A] transition-colors px-5 py-2 rounded-full text-xs text-white font-semibold">
                    Download PDF
                </a>
            </div>
        </section>
