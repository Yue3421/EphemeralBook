...
@section('content')
    <div class="max-w-6xl mx-auto px-8 py-12">
        <section class="bg-[#6E5A5A] rounded-2xl soft-shadow overflow-hidden">
            ...
            <div class="grid grid-cols-[1fr,1fr,120px] text-xs text-[#E6E1D8] px-6 py-3 border-b border-[#7A6A6A]">
            ...
            @forelse($users as $user)
                <div class="grid grid-cols-[1fr,1fr,120px] items-center px-6 py-3 text-sm text-white border-b border-[#7A6A6A] bg-[#8B7B7B]/40">
                    <div>{{ $user->name }}</div>
